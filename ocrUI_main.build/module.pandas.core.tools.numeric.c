...
static PyObject *impl_pandas$core$tools$numeric$$$function__1_to_numeric(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_70b0ece510eddb37487d885c2525dbd3);
