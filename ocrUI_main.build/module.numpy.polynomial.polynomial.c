...
static PyObject *impl_numpy$polynomial$polynomial$$$function__23__str_term_unicode(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_eb76948522142cd3900bdf6e9953986d)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_eb76948522142cd3900bdf6e9953986d = MAKE_FUNCTION_FRAME(codeobj_eb76948522142cd3900bdf6e9953986d, module_numpy$polynomial$polynomial, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_eb76948522142cd3900bdf6e9953986d);
...
static PyObject *impl_numpy$polynomial$polynomial$$$function__24__str_term_ascii(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_45123ddc882bcaedeacf5d269071ad0a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_45123ddc882bcaedeacf5d269071ad0a = MAKE_FUNCTION_FRAME(codeobj_45123ddc882bcaedeacf5d269071ad0a, module_numpy$polynomial$polynomial, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_45123ddc882bcaedeacf5d269071ad0a);
...
static PyObject *impl_numpy$polynomial$polynomial$$$function__25__repr_latex_term(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_afaf2310664d255d0b34bed73afdb9e0)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_afaf2310664d255d0b34bed73afdb9e0 = MAKE_FUNCTION_FRAME(codeobj_afaf2310664d255d0b34bed73afdb9e0, module_numpy$polynomial$polynomial, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_afaf2310664d255d0b34bed73afdb9e0);
