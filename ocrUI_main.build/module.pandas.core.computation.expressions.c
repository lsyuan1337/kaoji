...
static PyObject *impl_pandas$core$computation$expressions$$$function__1_set_use_numexpr(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_c2d0bf998be2db30a31548b73b27e5c7 = MAKE_FUNCTION_FRAME(codeobj_c2d0bf998be2db30a31548b73b27e5c7, module_pandas$core$computation$expressions, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_c2d0bf998be2db30a31548b73b27e5c7);
...
static PyObject *impl_pandas$core$computation$expressions$$$function__2_set_numexpr_threads(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_33975ea86426bb140a5d42a670bf8d31)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_33975ea86426bb140a5d42a670bf8d31 = MAKE_FUNCTION_FRAME(codeobj_33975ea86426bb140a5d42a670bf8d31, module_pandas$core$computation$expressions, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_33975ea86426bb140a5d42a670bf8d31);
...
static PyObject *impl_pandas$core$computation$expressions$$$function__3__evaluate_standard(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_fdfc3c056799798044ad982d3e2e5df3)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_fdfc3c056799798044ad982d3e2e5df3 = MAKE_FUNCTION_FRAME(codeobj_fdfc3c056799798044ad982d3e2e5df3, module_pandas$core$computation$expressions, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_fdfc3c056799798044ad982d3e2e5df3);
...
static PyObject *impl_pandas$core$computation$expressions$$$function__4__can_use_numexpr(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_7af8bcb7cc108995fadb4650d543831a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_7af8bcb7cc108995fadb4650d543831a = MAKE_FUNCTION_FRAME(codeobj_7af8bcb7cc108995fadb4650d543831a, module_pandas$core$computation$expressions, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_7af8bcb7cc108995fadb4650d543831a);
...
static PyObject *impl_pandas$core$computation$expressions$$$function__8__has_bool_dtype(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_4fd844a79dd034a4f5d5b7ae15ebbd6f)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_4fd844a79dd034a4f5d5b7ae15ebbd6f = MAKE_FUNCTION_FRAME(codeobj_4fd844a79dd034a4f5d5b7ae15ebbd6f, module_pandas$core$computation$expressions, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_4fd844a79dd034a4f5d5b7ae15ebbd6f);
...
static PyObject *impl_pandas$core$computation$expressions$$$function__9__bool_arith_fallback(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_a583a3311ea6b63b4ccb7d0d9a213c8b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_a583a3311ea6b63b4ccb7d0d9a213c8b = MAKE_FUNCTION_FRAME(codeobj_a583a3311ea6b63b4ccb7d0d9a213c8b, module_pandas$core$computation$expressions, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_a583a3311ea6b63b4ccb7d0d9a213c8b);
...
static PyObject *impl_pandas$core$computation$expressions$$$function__14_get_test_result(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_d83060e005ed0ac81e4883442f45b00b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_d83060e005ed0ac81e4883442f45b00b = MAKE_FUNCTION_FRAME(codeobj_d83060e005ed0ac81e4883442f45b00b, module_pandas$core$computation$expressions, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_d83060e005ed0ac81e4883442f45b00b);
