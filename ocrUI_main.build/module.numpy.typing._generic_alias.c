...
static PyObject *impl_numpy$typing$_generic_alias$$$function__4___origin__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_3b49d9871b1efe238beb07ea8730d7a0)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_3b49d9871b1efe238beb07ea8730d7a0 = MAKE_FUNCTION_FRAME(codeobj_3b49d9871b1efe238beb07ea8730d7a0, module_numpy$typing$_generic_alias, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_3b49d9871b1efe238beb07ea8730d7a0);
...
static PyObject *impl_numpy$typing$_generic_alias$$$function__5___args__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_fbc154af29e7d99397eea316e72be0a0)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_fbc154af29e7d99397eea316e72be0a0 = MAKE_FUNCTION_FRAME(codeobj_fbc154af29e7d99397eea316e72be0a0, module_numpy$typing$_generic_alias, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_fbc154af29e7d99397eea316e72be0a0);
...
static PyObject *impl_numpy$typing$_generic_alias$$$function__6___parameters__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_89d83ebc890b7996865b9ed3d79bf1d1)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_89d83ebc890b7996865b9ed3d79bf1d1 = MAKE_FUNCTION_FRAME(codeobj_89d83ebc890b7996865b9ed3d79bf1d1, module_numpy$typing$_generic_alias, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_89d83ebc890b7996865b9ed3d79bf1d1);
...
static PyObject *impl_numpy$typing$_generic_alias$$$function__8___call__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_62024c535497fa3a9845c6138b64e98e)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_62024c535497fa3a9845c6138b64e98e = MAKE_FUNCTION_FRAME(codeobj_62024c535497fa3a9845c6138b64e98e, module_numpy$typing$_generic_alias, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_62024c535497fa3a9845c6138b64e98e);
...
static PyObject *impl_numpy$typing$_generic_alias$$$function__18___getattribute__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_98e3e54cdb85d9e818f93ece7d48c15a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_98e3e54cdb85d9e818f93ece7d48c15a = MAKE_FUNCTION_FRAME(codeobj_98e3e54cdb85d9e818f93ece7d48c15a, module_numpy$typing$_generic_alias, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_98e3e54cdb85d9e818f93ece7d48c15a);
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        tmp_kw_call_value_0_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_1, mod_consts[133]);
        ...
        frame_fca7d2ee6754111b21d82b739f80fe81->m_frame.f_lineno = 201;
        {
            ...
            tmp_assign_source_31 = CALL_FUNCTION_WITH_POSARGS1_KWSPLIT(tmp_called_value_7, mod_consts[134], kw_values, mod_consts[135]);
        }
    ...
    }
    {
        ...
        tmp_args_element_value_5 = LOOKUP_ATTRIBUTE(tmp_expression_value_2, mod_consts[137]);
        if (tmp_args_element_value_5 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_args_element_value_7 = LOOKUP_ATTRIBUTE(tmp_expression_value_3, mod_consts[139]);
