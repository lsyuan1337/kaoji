...
static PyObject *impl_numpy$core$getlimits$$$function__13_min(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_323039dc896bba8d260b35231569250f)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_323039dc896bba8d260b35231569250f = MAKE_FUNCTION_FRAME(codeobj_323039dc896bba8d260b35231569250f, module_numpy$core$getlimits, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_323039dc896bba8d260b35231569250f);
...
static PyObject *impl_numpy$core$getlimits$$$function__14_max(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_b4cdb879274c348052ec049968c79673)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_b4cdb879274c348052ec049968c79673 = MAKE_FUNCTION_FRAME(codeobj_b4cdb879274c348052ec049968c79673, module_numpy$core$getlimits, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_b4cdb879274c348052ec049968c79673);
...
// Mark the execution in the "__spec__" value.
    ...
    // Tried code:
    {
        ...
        // Tried code:
        // Tried code:
        frame_6ed121784e7dea1e8bccde03d792010c_2 = MAKE_CLASS_FRAME(codeobj_6ed121784e7dea1e8bccde03d792010c, module_numpy$core$getlimits, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_6ed121784e7dea1e8bccde03d792010c_2);
