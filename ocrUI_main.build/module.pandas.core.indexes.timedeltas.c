...
static PyCodeObject *codeobj_9326b3105471f49ad63f18c25de7e87b;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_9326b3105471f49ad63f18c25de7e87b = MAKE_CODE_OBJECT(module_filename_obj, 218, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE | CO_FUTURE_ANNOTATIONS, mod_consts[124], mod_consts[124], mod_consts[137], NULL, 1, 0, 0);
...
static PyObject *impl_pandas$core$indexes$timedeltas$$$function__1___new__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_e81feaafde65891a47130018f194760a = MAKE_FUNCTION_FRAME(codeobj_e81feaafde65891a47130018f194760a, module_pandas$core$indexes$timedeltas, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_e81feaafde65891a47130018f194760a);
...
static PyObject *impl_pandas$core$indexes$timedeltas$$$function__2__is_comparable_dtype(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_98abe71b3bb07df1b3724f5b48522045)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_98abe71b3bb07df1b3724f5b48522045 = MAKE_FUNCTION_FRAME(codeobj_98abe71b3bb07df1b3724f5b48522045, module_pandas$core$indexes$timedeltas, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_98abe71b3bb07df1b3724f5b48522045);
...
static PyObject *impl_pandas$core$indexes$timedeltas$$$function__3_get_loc(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_a3496d82fe0eb45ef6ed2ddc8f52dd9b)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_a3496d82fe0eb45ef6ed2ddc8f52dd9b = MAKE_FUNCTION_FRAME(codeobj_a3496d82fe0eb45ef6ed2ddc8f52dd9b, module_pandas$core$indexes$timedeltas, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_a3496d82fe0eb45ef6ed2ddc8f52dd9b);
...
static PyObject *impl_pandas$core$indexes$timedeltas$$$function__4__maybe_cast_slice_bound(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_6fbdb154675ba2c32fb67936e95918ca)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_6fbdb154675ba2c32fb67936e95918ca = MAKE_FUNCTION_FRAME(codeobj_6fbdb154675ba2c32fb67936e95918ca, module_pandas$core$indexes$timedeltas, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_6fbdb154675ba2c32fb67936e95918ca);
...
static PyObject *impl_pandas$core$indexes$timedeltas$$$function__6_timedelta_range(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_a18c7384989bc100c9e72eb51d84f15c)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_a18c7384989bc100c9e72eb51d84f15c = MAKE_FUNCTION_FRAME(codeobj_a18c7384989bc100c9e72eb51d84f15c, module_pandas$core$indexes$timedeltas, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_a18c7384989bc100c9e72eb51d84f15c);
...
static PyObject *MAKE_FUNCTION_pandas$core$indexes$timedeltas$$$function__5_inferred_type(PyObject *annotations) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        mod_consts[125],
#endif
        codeobj_9326b3105471f49ad63f18c25de7e87b,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        annotations,
...
// Mark the execution in the "__spec__" value.
    ...
    branch_end_1:;
    {
        ...
        tmp_add_expr_right_1 = LOOKUP_ATTRIBUTE(tmp_expression_value_6, mod_consts[99]);
        if (tmp_add_expr_right_1 == NULL) {
            assert(ERROR_OCCURRED());
        ...
        frame_1cd6f746d7f85860c67bcc0e2852333b_2 = MAKE_CLASS_FRAME(codeobj_1cd6f746d7f85860c67bcc0e2852333b, module_pandas$core$indexes$timedeltas, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_1cd6f746d7f85860c67bcc0e2852333b_2);
        ...
        }
        {
            ...
            tmp_res = MAPPING_HAS_ITEM(locals_pandas$core$indexes$timedeltas$$$class__1_TimedeltaIndex_52, mod_consts[121]);
