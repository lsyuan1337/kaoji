...
static PyObject *impl_numpy$core$multiarray$$$function__2_concatenate(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_0632a6618f637c913df42e3251a664e2 = MAKE_FUNCTION_FRAME(codeobj_0632a6618f637c913df42e3251a664e2, module_numpy$core$multiarray, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_0632a6618f637c913df42e3251a664e2);
...
static PyObject *impl_numpy$core$multiarray$$$function__5_lexsort(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_e9057517e52e723b7ad41b1f11dd23cc)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_e9057517e52e723b7ad41b1f11dd23cc = MAKE_FUNCTION_FRAME(codeobj_e9057517e52e723b7ad41b1f11dd23cc, module_numpy$core$multiarray, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_e9057517e52e723b7ad41b1f11dd23cc);
