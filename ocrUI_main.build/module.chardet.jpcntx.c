...
static PyCodeObject *codeobj_03e914197f40ab75222114b70684e8df;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_03e914197f40ab75222114b70684e8df = MAKE_CODE_OBJECT(module_filename_obj, 194, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[89], mod_consts[89], mod_consts[101], NULL, 1, 0, 0);
...
static PyObject *impl_chardet$jpcntx$$$function__8_charset_name(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    // Local variable declarations.
    PyObject *par_self = python_pars[0];
    struct Nuitka_FrameObject *frame_03e914197f40ab75222114b70684e8df;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *tmp_return_value = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    static struct Nuitka_FrameObject *cache_frame_03e914197f40ab75222114b70684e8df = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_03e914197f40ab75222114b70684e8df)) {
        Py_XDECREF(cache_frame_03e914197f40ab75222114b70684e8df);

#if _DEBUG_REFCOUNTS
        if (cache_frame_03e914197f40ab75222114b70684e8df == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_03e914197f40ab75222114b70684e8df = MAKE_FUNCTION_FRAME(codeobj_03e914197f40ab75222114b70684e8df, module_chardet$jpcntx, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_03e914197f40ab75222114b70684e8df->m_type_description == NULL);
    frame_03e914197f40ab75222114b70684e8df = cache_frame_03e914197f40ab75222114b70684e8df;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_03e914197f40ab75222114b70684e8df);
    assert(Py_REFCNT(frame_03e914197f40ab75222114b70684e8df) == 2);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_03e914197f40ab75222114b70684e8df, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_03e914197f40ab75222114b70684e8df->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_03e914197f40ab75222114b70684e8df, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_03e914197f40ab75222114b70684e8df,
        type_description_1,
        par_self
    );
    ...
    // Release cached frame if used for exception.
    if (frame_03e914197f40ab75222114b70684e8df == cache_frame_03e914197f40ab75222114b70684e8df) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_03e914197f40ab75222114b70684e8df);
        cache_frame_03e914197f40ab75222114b70684e8df = NULL;
    }

    assertFrameObject(frame_03e914197f40ab75222114b70684e8df);
...
static PyObject *MAKE_FUNCTION_chardet$jpcntx$$$function__8_charset_name(PyObject *annotations) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        mod_consts[90],
#endif
        codeobj_03e914197f40ab75222114b70684e8df,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        annotations,
