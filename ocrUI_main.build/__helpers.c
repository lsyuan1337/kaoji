...
PyObject *CALL_FUNCTION_WITH_ARGS27(PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 27 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(function, args, 27);
        }
        ...
        if (method->m_object == NULL) {
            ...
            return Nuitka_CallFunctionPosArgs(method->m_function, args, 27);
        } else {
            if (unlikely(Py_EnterRecursiveCall((char *)" while calling a Python object"))) {
                return NULL;
            }
            ...
            if (function->m_args_simple && 27 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(function, method->m_object, args, 27);
            }
...
#else
    return _PyFunction_Vectorcall(called, args, 27, NULL);
#endif
#endif
#if !defined(_NUITKA_EXPERIMENTAL_DISABLE_TYPE_CREATION_OPT)
    } else if (PyType_Check(called)) {
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs((struct Nuitka_FunctionObject const *)init_method, obj, args, 27);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS27(init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS28(PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
...
#else
    return _PyFunction_Vectorcall(called, args, 28, NULL);
#endif
#endif
#if !defined(_NUITKA_EXPERIMENTAL_DISABLE_TYPE_CREATION_OPT)
    } else if (PyType_Check(called)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        if (is_compiled_function) {
                            ...
                            result = CALL_FUNCTION_WITH_ARGS28(init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS41(PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 41 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(function, args, 41);
        }
        ...
        if (method->m_object == NULL) {
            ...
            return Nuitka_CallFunctionPosArgs(method->m_function, args, 41);
        } else {
            if (unlikely(Py_EnterRecursiveCall((char *)" while calling a Python object"))) {
                return NULL;
            }
            ...
            if (function->m_args_simple && 41 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(function, method->m_object, args, 41);
            }
...
#else
    return _PyFunction_Vectorcall(called, args, 41, NULL);
#endif
#endif
#if !defined(_NUITKA_EXPERIMENTAL_DISABLE_TYPE_CREATION_OPT)
    } else if (PyType_Check(called)) {
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs((struct Nuitka_FunctionObject const *)init_method, obj, args, 41);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS41(init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS46(PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 46 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(function, args, 46);
        }
        ...
        if (method->m_object == NULL) {
            ...
            return Nuitka_CallFunctionPosArgs(method->m_function, args, 46);
        } else {
            if (unlikely(Py_EnterRecursiveCall((char *)" while calling a Python object"))) {
                return NULL;
            }
            ...
            if (function->m_args_simple && 46 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(function, method->m_object, args, 46);
            }
...
#else
    return _PyFunction_Vectorcall(called, args, 46, NULL);
#endif
#endif
#if !defined(_NUITKA_EXPERIMENTAL_DISABLE_TYPE_CREATION_OPT)
    } else if (PyType_Check(called)) {
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs((struct Nuitka_FunctionObject const *)init_method, obj, args, 46);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS46(init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS63(PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 63 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(function, args, 63);
        }
        ...
        if (method->m_object == NULL) {
            ...
            return Nuitka_CallFunctionPosArgs(method->m_function, args, 63);
        } else {
            if (unlikely(Py_EnterRecursiveCall((char *)" while calling a Python object"))) {
                return NULL;
            }
            ...
            if (function->m_args_simple && 63 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(function, method->m_object, args, 63);
            }
...
#else
    return _PyFunction_Vectorcall(called, args, 63, NULL);
#endif
#endif
#if !defined(_NUITKA_EXPERIMENTAL_DISABLE_TYPE_CREATION_OPT)
    } else if (PyType_Check(called)) {
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs((struct Nuitka_FunctionObject const *)init_method, obj, args, 63);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS63(init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_FUNCTION_WITH_ARGS88(PyObject *called, PyObject *const *args) {
    CHECK_OBJECT(called);
    ...
    if (Nuitka_Function_Check(called)) {
        ...
        if (function->m_args_simple && 88 == function->m_args_positional_count){
            ...
            result = Nuitka_CallFunctionPosArgs(function, args, 88);
        }
        ...
        if (method->m_object == NULL) {
            ...
            return Nuitka_CallFunctionPosArgs(method->m_function, args, 88);
        } else {
            if (unlikely(Py_EnterRecursiveCall((char *)" while calling a Python object"))) {
                return NULL;
            }
            ...
            if (function->m_args_simple && 88 + 1 == function->m_args_positional_count) {
                ...
                result = Nuitka_CallMethodFunctionPosArgs(function, method->m_object, args, 88);
            }
...
#else
    return _PyFunction_Vectorcall(called, args, 88, NULL);
#endif
#endif
#if !defined(_NUITKA_EXPERIMENTAL_DISABLE_TYPE_CREATION_OPT)
    } else if (PyType_Check(called)) {
            ...
            if (likely(obj != NULL)) {
                ...
                if (NuitkaType_HasFeatureClass(type) && type->tp_init != NULL) {
                    if (type->tp_init == default_tp_init_wrapper) {
                        ...
                        PyObject *result;
                        if (is_compiled_function) {
                            result = Nuitka_CallMethodFunctionPosArgs((struct Nuitka_FunctionObject const *)init_method, obj, args, 88);
                        } else {
                            result = CALL_FUNCTION_WITH_ARGS88(init_method, args);
                            if (init_method_needs_release) {
                                Py_DECREF(init_method);
                            }
                        }
...
PyObject *CALL_METHOD_WITH_ARGS15(PyObject *source, PyObject *attr_name, PyObject *const *args) {
    CHECK_OBJECT(source);
    CHECK_OBJECT(attr_name);
        ...
        if (descr != NULL) {
            ...
            if (NuitkaType_HasFeatureClass(Py_TYPE(descr))) {
                ...
                if (func != NULL && PyDescr_IsData(descr)) {
                    ...
                    PyObject *result = CALL_FUNCTION_WITH_ARGS15(called_object, args)
;
                    Py_DECREF(called_object);
                    return result;
                }
...
;
        ...
        if (descr != NULL) {
            ...
            PyObject *result = CALL_FUNCTION_WITH_ARGS15(descr, args)
;
            Py_DECREF(descr);
            return result;
        }
        ...
        // so we need not release it in this branch.
        if (called_object != NULL) {
            return CALL_FUNCTION_WITH_ARGS15(called_object, args)
;
        }
        ...
        if (called_object != NULL) {
            ...
            if (descr_get == Nuitka_Function_Type.tp_descr_get) {
                ...
                PyObject *result = CALL_FUNCTION_WITH_ARGS15(method, args)
;
                Py_DECREF(method);
                return result;
            } else {
