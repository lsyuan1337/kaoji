...
static PyObject *impl_matplotlib$cm$$$function__32_norm(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_da9d2d01771674f39d173cc969c9fa19)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_da9d2d01771674f39d173cc969c9fa19 = MAKE_FUNCTION_FRAME(codeobj_da9d2d01771674f39d173cc969c9fa19, module_matplotlib$cm, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_da9d2d01771674f39d173cc969c9fa19);
...
static PyObject *impl_matplotlib$cm$$$function__33_norm(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_ea88174fd9355f2f074067e95166dd66)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_ea88174fd9355f2f074067e95166dd66 = MAKE_FUNCTION_FRAME(codeobj_ea88174fd9355f2f074067e95166dd66, module_matplotlib$cm, sizeof(nuitka_bool)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_ea88174fd9355f2f074067e95166dd66);
...
// Mark the execution in the "__spec__" value.
    ...
    // Tried code:
    {
        ...
        // Tried code:
        // Tried code:
        frame_85db57089d1fbe2ef0ae2c929aa76135_2 = MAKE_CLASS_FRAME(codeobj_85db57089d1fbe2ef0ae2c929aa76135, module_matplotlib$cm, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_85db57089d1fbe2ef0ae2c929aa76135_2);
