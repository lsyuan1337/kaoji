...
static PyCodeObject *codeobj_ce5de149095b1cfefe26c46a06d3b234;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_ce5de149095b1cfefe26c46a06d3b234 = MAKE_CODE_OBJECT(module_filename_obj, 61, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[12], mod_consts[12], mod_consts[177], NULL, 1, 0, 0);
...
static PyObject *impl_colorama$ansitowin32$$$function__9_closed(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    PyObject *par_self = python_pars[0];
    PyObject *var_stream = NULL;
    struct Nuitka_FrameObject *frame_ce5de149095b1cfefe26c46a06d3b234;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    ...
    PyTracebackObject *exception_keeper_tb_2;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_2;
    static struct Nuitka_FrameObject *cache_frame_ce5de149095b1cfefe26c46a06d3b234 = NULL;
    PyObject *exception_keeper_type_3;
    PyObject *exception_keeper_value_3;
    PyTracebackObject *exception_keeper_tb_3;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_3;
    ...
    // Actual function body.
    // Tried code:
    if (isFrameUnusable(cache_frame_ce5de149095b1cfefe26c46a06d3b234)) {
        Py_XDECREF(cache_frame_ce5de149095b1cfefe26c46a06d3b234);

#if _DEBUG_REFCOUNTS
        if (cache_frame_ce5de149095b1cfefe26c46a06d3b234 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_ce5de149095b1cfefe26c46a06d3b234 = MAKE_FUNCTION_FRAME(codeobj_ce5de149095b1cfefe26c46a06d3b234, module_colorama$ansitowin32, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_ce5de149095b1cfefe26c46a06d3b234->m_type_description == NULL);
    frame_ce5de149095b1cfefe26c46a06d3b234 = cache_frame_ce5de149095b1cfefe26c46a06d3b234;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_ce5de149095b1cfefe26c46a06d3b234);
    assert(Py_REFCNT(frame_ce5de149095b1cfefe26c46a06d3b234) == 2);
    ...
    if (exception_keeper_tb_1 == NULL) {
        exception_keeper_tb_1 = MAKE_TRACEBACK(frame_ce5de149095b1cfefe26c46a06d3b234, exception_keeper_lineno_1);
    } else if (exception_keeper_lineno_1 != 0) {
        exception_keeper_tb_1 = ADD_TRACEBACK(exception_keeper_tb_1, frame_ce5de149095b1cfefe26c46a06d3b234, exception_keeper_lineno_1);
    }
    ...
    if (exception_tb && exception_tb->tb_frame == &frame_ce5de149095b1cfefe26c46a06d3b234->m_frame) frame_ce5de149095b1cfefe26c46a06d3b234->m_frame.f_lineno = exception_tb->tb_lineno;
    type_description_1 = "oo";
    goto try_except_handler_3;
    branch_end_1:;
    NUITKA_CANNOT_GET_HERE("tried codes exits in all cases");
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_ce5de149095b1cfefe26c46a06d3b234, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_ce5de149095b1cfefe26c46a06d3b234->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_ce5de149095b1cfefe26c46a06d3b234, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_ce5de149095b1cfefe26c46a06d3b234,
        type_description_1,
        par_self,
        var_stream
    );
    ...
    // Release cached frame if used for exception.
    if (frame_ce5de149095b1cfefe26c46a06d3b234 == cache_frame_ce5de149095b1cfefe26c46a06d3b234) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_ce5de149095b1cfefe26c46a06d3b234);
        cache_frame_ce5de149095b1cfefe26c46a06d3b234 = NULL;
    }

    assertFrameObject(frame_ce5de149095b1cfefe26c46a06d3b234);
...
static PyObject *MAKE_FUNCTION_colorama$ansitowin32$$$function__9_closed() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        mod_consts[145],
#endif
        codeobj_ce5de149095b1cfefe26c46a06d3b234,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
