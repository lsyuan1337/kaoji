...
static void createModuleCodeObjects(void) {
    ...
    codeobj_d567b43a5f6ccd9a6e2fec732c62961b = MAKE_CODE_OBJECT(module_filename_obj, 136, CO_GENERATOR | CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[28], mod_consts[28], mod_consts[81], NULL, 1, 0, 0);
    codeobj_5cfa81a45f33da228a72f6f1c1b8de5a = MAKE_CODE_OBJECT(module_filename_obj, 164, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[2], mod_consts[2], mod_consts[82], NULL, 1, 0, 0);
}
...
static PyObject *numpy$lib$arrayterator$$$function__5_flat$$$genobj__1_flat_context(struct Nuitka_GeneratorObject *generator, PyObject *yield_return_value) {
    ...
    if (isFrameUnusable(cache_m_frame)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_m_frame = MAKE_FUNCTION_FRAME(codeobj_d567b43a5f6ccd9a6e2fec732c62961b, module_numpy$lib$arrayterator, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
...
static PyObject *impl_numpy$lib$arrayterator$$$function__6_shape(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_5cfa81a45f33da228a72f6f1c1b8de5a)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_5cfa81a45f33da228a72f6f1c1b8de5a = MAKE_FUNCTION_FRAME(codeobj_5cfa81a45f33da228a72f6f1c1b8de5a, module_numpy$lib$arrayterator, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_5cfa81a45f33da228a72f6f1c1b8de5a);
