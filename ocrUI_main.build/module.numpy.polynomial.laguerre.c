...
static PyObject *impl_numpy$polynomial$laguerre$$$function__22_lagcompanion(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_95a30b2add44578cb8479fa19d8f1351)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_95a30b2add44578cb8479fa19d8f1351 = MAKE_FUNCTION_FRAME(codeobj_95a30b2add44578cb8479fa19d8f1351, module_numpy$polynomial$laguerre, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_95a30b2add44578cb8479fa19d8f1351);
...
static PyObject *impl_numpy$polynomial$laguerre$$$function__23_lagroots(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_a6c8e80ed15350de03224359d22be8d2)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_a6c8e80ed15350de03224359d22be8d2 = MAKE_FUNCTION_FRAME(codeobj_a6c8e80ed15350de03224359d22be8d2, module_numpy$polynomial$laguerre, sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_a6c8e80ed15350de03224359d22be8d2);
...
static PyObject *impl_numpy$polynomial$laguerre$$$function__24_laggauss(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_f0737df36faced1b47af7ab490a4d763)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_f0737df36faced1b47af7ab490a4d763 = MAKE_FUNCTION_FRAME(codeobj_f0737df36faced1b47af7ab490a4d763, module_numpy$polynomial$laguerre, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_f0737df36faced1b47af7ab490a4d763);
...
static PyObject *impl_numpy$polynomial$laguerre$$$function__25_lagweight(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_31210485ac1fe6979d08b8f6768eb673)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_31210485ac1fe6979d08b8f6768eb673 = MAKE_FUNCTION_FRAME(codeobj_31210485ac1fe6979d08b8f6768eb673, module_numpy$polynomial$laguerre, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_31210485ac1fe6979d08b8f6768eb673);
...
// Mark the execution in the "__spec__" value.
    ...
    branch_end_1:;
    {
        ...
        frame_719d850fcec9357233d8bab5b9dfa153_2 = MAKE_CLASS_FRAME(codeobj_719d850fcec9357233d8bab5b9dfa153, module_numpy$polynomial$laguerre, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_719d850fcec9357233d8bab5b9dfa153_2);
        ...
        // Framed code:
        {
            ...
            tmp_res = MAPPING_HAS_ITEM(locals_numpy$polynomial$laguerre$$$class__1_Laguerre_1605, mod_consts[186]);
