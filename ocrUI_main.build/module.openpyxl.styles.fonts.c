...
static PyCodeObject *codeobj_3e0a676b652e5b419eb3981a6e0d6f96;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_3e0a676b652e5b419eb3981a6e0d6f96 = MAKE_CODE_OBJECT(module_filename_obj, 101, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[26], mod_consts[26], mod_consts[125], NULL, 2, 0, 0);
}
...
static PyObject *impl_openpyxl$styles$fonts$$$function__3_from_tree(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_3e0a676b652e5b419eb3981a6e0d6f96;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    ...
    PyObject *tmp_return_value = NULL;
    static struct Nuitka_FrameObject *cache_frame_3e0a676b652e5b419eb3981a6e0d6f96 = NULL;
    PyObject *exception_keeper_type_1;
    PyObject *exception_keeper_value_1;
    PyTracebackObject *exception_keeper_tb_1;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_1;
    ...
    // Actual function body.
    // Tried code:
    if (isFrameUnusable(cache_frame_3e0a676b652e5b419eb3981a6e0d6f96)) {
        Py_XDECREF(cache_frame_3e0a676b652e5b419eb3981a6e0d6f96);

#if _DEBUG_REFCOUNTS
        if (cache_frame_3e0a676b652e5b419eb3981a6e0d6f96 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_3e0a676b652e5b419eb3981a6e0d6f96 = MAKE_FUNCTION_FRAME(codeobj_3e0a676b652e5b419eb3981a6e0d6f96, module_openpyxl$styles$fonts, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_3e0a676b652e5b419eb3981a6e0d6f96->m_type_description == NULL);
    frame_3e0a676b652e5b419eb3981a6e0d6f96 = cache_frame_3e0a676b652e5b419eb3981a6e0d6f96;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_3e0a676b652e5b419eb3981a6e0d6f96);
    assert(Py_REFCNT(frame_3e0a676b652e5b419eb3981a6e0d6f96) == 2);
    ...
    // Framed code:
    {
        ...
        frame_3e0a676b652e5b419eb3981a6e0d6f96->m_frame.f_lineno = 106;
    ...
    }
    {
        ...
        frame_3e0a676b652e5b419eb3981a6e0d6f96->m_frame.f_lineno = 107;
    ...
    branch_yes_1:;
    {
        ...
        frame_3e0a676b652e5b419eb3981a6e0d6f96->m_frame.f_lineno = 108;
    ...
    branch_no_1:;
    {
        ...
        frame_3e0a676b652e5b419eb3981a6e0d6f96->m_frame.f_lineno = 109;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_3e0a676b652e5b419eb3981a6e0d6f96, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_3e0a676b652e5b419eb3981a6e0d6f96->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_3e0a676b652e5b419eb3981a6e0d6f96, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_3e0a676b652e5b419eb3981a6e0d6f96,
        type_description_1,
        par_cls,
        par_node,
        var_underline,
    ...
    // Release cached frame if used for exception.
    if (frame_3e0a676b652e5b419eb3981a6e0d6f96 == cache_frame_3e0a676b652e5b419eb3981a6e0d6f96) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_3e0a676b652e5b419eb3981a6e0d6f96);
        cache_frame_3e0a676b652e5b419eb3981a6e0d6f96 = NULL;
    }

    assertFrameObject(frame_3e0a676b652e5b419eb3981a6e0d6f96);
...
static PyObject *MAKE_FUNCTION_openpyxl$styles$fonts$$$function__3_from_tree() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        mod_consts[110],
#endif
        codeobj_3e0a676b652e5b419eb3981a6e0d6f96,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
