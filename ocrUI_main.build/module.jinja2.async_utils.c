...
static PyCodeObject *codeobj_abf06f8af714b0a4186311780cc44154;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_abf06f8af714b0a4186311780cc44154 = MAKE_CODE_OBJECT(module_filename_obj, 34, CO_OPTIMIZED | CO_NEWLOCALS | CO_VARARGS | CO_VARKEYWORDS, mod_consts[18], mod_consts[18], mod_consts[69], mod_consts[70], 0, 0, 0);
}
...
static PyObject *impl_jinja2$async_utils$$$function__1_async_variant$$$function__1_decorator$$$function__3_wrapper(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    PyObject *var_b = NULL;
    struct Nuitka_FrameObject *frame_abf06f8af714b0a4186311780cc44154;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    PyObject *tmp_return_value = NULL;
    static struct Nuitka_FrameObject *cache_frame_abf06f8af714b0a4186311780cc44154 = NULL;
    PyObject *exception_keeper_type_1;
    PyObject *exception_keeper_value_1;
    PyTracebackObject *exception_keeper_tb_1;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_1;
    ...
    // Actual function body.
    // Tried code:
    if (isFrameUnusable(cache_frame_abf06f8af714b0a4186311780cc44154)) {
        Py_XDECREF(cache_frame_abf06f8af714b0a4186311780cc44154);

#if _DEBUG_REFCOUNTS
        if (cache_frame_abf06f8af714b0a4186311780cc44154 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_abf06f8af714b0a4186311780cc44154 = MAKE_FUNCTION_FRAME(codeobj_abf06f8af714b0a4186311780cc44154, module_jinja2$async_utils, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_abf06f8af714b0a4186311780cc44154->m_type_description == NULL);
    frame_abf06f8af714b0a4186311780cc44154 = cache_frame_abf06f8af714b0a4186311780cc44154;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_abf06f8af714b0a4186311780cc44154);
    assert(Py_REFCNT(frame_abf06f8af714b0a4186311780cc44154) == 2);
    ...
    // Framed code:
    {
        ...
        frame_abf06f8af714b0a4186311780cc44154->m_frame.f_lineno = 37;
        tmp_assign_source_1 = CALL_FUNCTION_WITH_SINGLE_ARG(tmp_called_value_1, tmp_args_element_value_1);
        if (tmp_assign_source_1 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_abf06f8af714b0a4186311780cc44154, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_abf06f8af714b0a4186311780cc44154->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_abf06f8af714b0a4186311780cc44154, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_abf06f8af714b0a4186311780cc44154,
        type_description_1,
        par_args,
        par_kwargs,
        var_b,
    ...
    // Release cached frame if used for exception.
    if (frame_abf06f8af714b0a4186311780cc44154 == cache_frame_abf06f8af714b0a4186311780cc44154) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_abf06f8af714b0a4186311780cc44154);
        cache_frame_abf06f8af714b0a4186311780cc44154 = NULL;
    }

    assertFrameObject(frame_abf06f8af714b0a4186311780cc44154);
...
static PyObject *MAKE_FUNCTION_jinja2$async_utils$$$function__1_async_variant$$$function__1_decorator$$$function__3_wrapper(struct Nuitka_CellObject **closure) {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        mod_consts[19],
#endif
        codeobj_abf06f8af714b0a4186311780cc44154,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
