...
static PyCodeObject *codeobj_2f3ed1e045da28e6b2bb4a35478e8f43;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_2f3ed1e045da28e6b2bb4a35478e8f43 = MAKE_CODE_OBJECT(module_filename_obj, 152, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[84], mod_consts[84], mod_consts[116], NULL, 1, 0, 0);
}
...
static PyObject *impl_scipy$integrate$_ivp$base$$$function__3_step_size(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_2f3ed1e045da28e6b2bb4a35478e8f43;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    NUITKA_MAY_BE_UNUSED int exception_lineno = 0;
    PyObject *tmp_return_value = NULL;
    static struct Nuitka_FrameObject *cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43 = NULL;

    // Actual function body.
    if (isFrameUnusable(cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43)) {
        Py_XDECREF(cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43);

#if _DEBUG_REFCOUNTS
        if (cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43 = MAKE_FUNCTION_FRAME(codeobj_2f3ed1e045da28e6b2bb4a35478e8f43, module_scipy$integrate$_ivp$base, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    assert(cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43->m_type_description == NULL);
    frame_2f3ed1e045da28e6b2bb4a35478e8f43 = cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43;

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_2f3ed1e045da28e6b2bb4a35478e8f43);
    assert(Py_REFCNT(frame_2f3ed1e045da28e6b2bb4a35478e8f43) == 2);
    ...
    branch_no_1:;
    {
        ...
        frame_2f3ed1e045da28e6b2bb4a35478e8f43->m_frame.f_lineno = 157;
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_2f3ed1e045da28e6b2bb4a35478e8f43, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_2f3ed1e045da28e6b2bb4a35478e8f43->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_2f3ed1e045da28e6b2bb4a35478e8f43, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_2f3ed1e045da28e6b2bb4a35478e8f43,
        type_description_1,
        par_self
    );
    ...
    // Release cached frame if used for exception.
    if (frame_2f3ed1e045da28e6b2bb4a35478e8f43 == cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif
        Py_DECREF(cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43);
        cache_frame_2f3ed1e045da28e6b2bb4a35478e8f43 = NULL;
    }

    assertFrameObject(frame_2f3ed1e045da28e6b2bb4a35478e8f43);
...
static PyObject *MAKE_FUNCTION_scipy$integrate$_ivp$base$$$function__3_step_size() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        mod_consts[85],
#endif
        codeobj_2f3ed1e045da28e6b2bb4a35478e8f43,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
