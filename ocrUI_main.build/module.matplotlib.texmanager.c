...
static void createModuleCodeObjects(void) {
    ...
    codeobj_aaa7398c25ee22fda6a30918ea6e46fd = MAKE_CODE_OBJECT(module_filename_obj, 102, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[12], mod_consts[12], mod_consts[225], NULL, 1, 0, 0);
...
static PyObject *impl_matplotlib$texmanager$$$function__2___new__(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_aaa7398c25ee22fda6a30918ea6e46fd)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_aaa7398c25ee22fda6a30918ea6e46fd = MAKE_FUNCTION_FRAME(codeobj_aaa7398c25ee22fda6a30918ea6e46fd, module_matplotlib$texmanager, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_aaa7398c25ee22fda6a30918ea6e46fd);
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_2)) {
            ...
            tmp_assign_source_10 = IMPORT_NAME(tmp_import_name_from_2, mod_consts[93]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_3)) {
            ...
            tmp_assign_source_12 = IMPORT_NAME(tmp_import_name_from_3, mod_consts[176]);
        }
    ...
    // Tried code:
    {
        ...
        if (PyModule_Check(tmp_import_name_from_4)) {
            ...
            tmp_assign_source_15 = IMPORT_NAME(tmp_import_name_from_4, mod_consts[179]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_6)) {
            ...
            tmp_assign_source_17 = IMPORT_NAME(tmp_import_name_from_6, mod_consts[150]);
        }
