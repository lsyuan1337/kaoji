...
static PyObject *impl_PIL$ImageGrab$$$function__1_grab(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_634192eaf239675305925b7562fbec1d = MAKE_FUNCTION_FRAME(codeobj_634192eaf239675305925b7562fbec1d, module_PIL$ImageGrab, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_634192eaf239675305925b7562fbec1d);
...
static PyObject *impl_PIL$ImageGrab$$$function__2_grabclipboard(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_3cabc21f7398c48d11b97b6a6102b626)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_3cabc21f7398c48d11b97b6a6102b626 = MAKE_FUNCTION_FRAME(codeobj_3cabc21f7398c48d11b97b6a6102b626, module_PIL$ImageGrab, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_3cabc21f7398c48d11b97b6a6102b626);
...
// Mark the execution in the "__spec__" value.
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_756871043ce983fa9d7299ad9286f541);
